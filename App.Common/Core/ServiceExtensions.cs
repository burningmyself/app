...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// 将Common服务，各个<see cref="OsharpPack"/>模块的服务添加到服务容器中
        /// </summary>
        public static IServiceCollection AddCommon<TOsharpPackManager>(this IServiceCollection services, Action<IOsharpBuilder> builderAction = null)
        ...
        /// <summary>
        /// 从服务提供者中获取CommonOptions
        /// </summary>
        public static OsharpOptions GetCommonOptions(this IServiceProvider provider)
        {
